...
#define prs() printf(" ")
#define prn() printf("\n")
#define re(i,a,b) for(register i=a;i<=b;++i)
#define fo(i,a,b) for(register i=a;i<b;++i)
...
typedef priority_queue<int,vci,greater<int>> mnpi;
typedef priority_queue<pii> mxpp;
typedef priority_queue<pii,vcp,greater<pii>> mnpp;
