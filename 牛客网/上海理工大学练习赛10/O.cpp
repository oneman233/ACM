...
signed main() {
    ...
    scanf("%lf%lf",&ox2,&oy2);
    scanf("%lf%lf",&ox3,&oy3);
    db a=((oy2-oy1)*(oy3*oy3-oy1*oy1+ox3*ox3-ox1*ox1)-(oy3-oy1)*(oy2*oy2-oy1*oy1+ox2*ox2-ox1*ox1))/(2.0*((ox3-ox1)*(oy2-oy1)-(ox2-ox1)*(oy3-oy1)));
    db b=((ox2-ox1)*(ox3*ox3-ox1*ox1+oy3*oy3-oy1*oy1)-(ox3-ox1)*(ox2*ox2-ox1*ox1+oy2*oy2-oy1*oy1))/(2.0*((oy3-oy1)*(ox2-ox1)-(oy2-oy1)*(ox3-ox1)));
    printf("%.3lf %.3lf",a,b);
    return 0;
}
